...
node ${_pwd}/updatePackageJSON.js $_platform
...
# then
#    echo "安装 vite 依赖 ..."
#    npm i @babel/eslint-parser@7.17.0 @commitlint/cli@17.0.3 @commitlint/config-conventional@17.0.3 @vue/eslint-config-prettier@7.0.0 cz-customizable@6.9.1 eslint@8.25.0  eslint-plugin-vue@9.6.0 husky@7.0.1  lint-staged@9.5.0 prettier@2.7.1 vite-plugin-eslint@1.8.1 --save-dev
...
# 创建 .eslintrc.js
node ${_pwd}/createESlintrc.js $_platform
# 有 .git 文件夹再初始化
npm run prepare
